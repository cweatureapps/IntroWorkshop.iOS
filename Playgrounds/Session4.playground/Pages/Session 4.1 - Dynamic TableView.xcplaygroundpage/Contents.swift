...
3. When you tap on a row, it gets highlighted. Do this in the `cellForRowAt` method. The following line prevents any style change when a row is selected.
...
2. And then rename `heightForRowAt` to `estimatedHeightForRowAt`
